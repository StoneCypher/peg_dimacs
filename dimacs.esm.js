...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$startRuleFunctions = { DimacsDocument: peg$parseDimacsDocument },
      peg$startRuleFunction  = peg$parseDimacsDocument,

      peg$c0 = function(R, Rs) { let parse_tree = [R, ...(Rs.map(lr => lr[1]))];
          return { format, comment: comments.join('\n'), var_count, clause_count, claims }; },
      peg$c1 = "c",
      peg$c2 = peg$literalExpectation("c", false),
      peg$c3 = /^[^\n]/,
      peg$c4 = peg$classExpectation(["\n"], true, false),
      peg$c5 = function(t) { let text = t.join('').trim();
          comments.push(text);
          return ast('comment', { text }); },
      peg$c6 = "p",
      peg$c7 = peg$literalExpectation("p", false),
      peg$c8 = "cnf",
      peg$c9 = peg$literalExpectation("cnf", false),
      ...
      peg$c16 = function() { return parseInt(text()); },
      peg$c17 = "\r\n",
  ...
  function peg$parseDimacsDocument() {
